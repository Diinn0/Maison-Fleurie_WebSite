            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <li v-for="onglet in onglets">
                    <NuxtLink v-if="!hasChildren(onglet) && onglet.parentId == null"
                        href="#"
                    ...
                    <div v-else v-if="onglet.parentId == null">
...
const hasChildren = (onglet) => {
  if (onglets.value.filter((ong) => ong.parentId === onglet.id && ong.id !== onglet.id).length > 0) {
    return onglets.value.filter((ong) => ong.parentId === onglet.id && ong.id !== onglet.id);
  }
