...
<template>
  <li class="list-group object-contain" v-for="element2 in (onglets != null ? onglets.filter(el => el.parentId === condition) : [])" :data-id="element2.id">
    <div class="bg-gray-300 m-1 p-3 rounded-md text-center flex">
      ...
      <div class="align-right grow-0 flex">
        <a :href="'/admin/nav/' + element2.id" class="mr-2 mt-0.5">
          <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="text-orange-600 w-5 h-5">
